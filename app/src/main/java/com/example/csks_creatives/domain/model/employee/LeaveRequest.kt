...
data class LeaveRequest(
    ...
    @PropertyName(LEAVE_DURATION) val leaveDuration: LeaveDuration = LeaveDuration.FULL_DAY,
    ...
    constructor() : this("", Timestamp.now(), LeaveDuration.FULL_DAY, "", "", LeaveApprovalStatus.UN_APPROVED)
}